...
// inMemory Queue implements a queue that stores messages in memory
// Messages can be enqueued concurrently but the returned iterator is not safe for concurrent access
...
// This function can serve as a QueueFactory
